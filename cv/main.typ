...
= Time allocations
Over my career, I have been *PI or co-I of projects securing #SI(400, "MCPU.hr")* (4,000,000€, assuming a price of 0.01€/CPU hr). My developments also enabled additional projects for a total of more than #SI(100, "MCPU.hr").
#v(-1em)
#entryGroup(
  //   ..entry(
  //     date: [2024--25],
  ...
  ..entry(
    ...
    location: [#box(baseline: 10%, image(height: .9em, "images/BSC-blue.svg"))#box(baseline: 10%, image(
        height: .9em,
        "images/EuroHPC.svg",
      ))],
    description: [#v(-.5em)*#SI(250, "MCPU.hr")* (EuroHPC) + *#SI(60, "MCPU.hr")* (Spanish national call). Suite of high-resolution simulations to support ESA's ARRAKIHS mission to investigate the nature of dark matter.],
  ),
  ..entry(
    date: [2024],
...
= Responsibilities
  ...
  ..entrynohl(
    ...
    title: [IAP Seminars],
    location: [],
    description: [In charge of the organization of IAP's seminars (weekly).],
  ),
  ..entry(
    date: [2022--now],
...
#v(-2em)
  ...
  ..entry(
    ...
    location: [],
    description: [Supervision of 9 Master's students. The work of the students in bold led to a submitted paper:
