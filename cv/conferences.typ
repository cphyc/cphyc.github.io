...
Invited talks at conferences and seminars are listed below. Poster presentations are highlighted as "#fa-icon("newspaper")".
#v(-.5em)
...
#let data = (
  "Invited talks": (
    (
      date: [06/2025],
      title: [National Astronomical Meeting],
    ...
    (
      date: [06/2025],
      title: [yt workshop],
      location: [Royal Astronomical Observatory, Edinburgh, UK],
      description: none,
    ),
    (
      date: [03/2023],
      title: [Connecting Galaxies to Cosmology visiting Program],
      location: [KITP, Santa Barbara, USA],
      description: none,
    ),
    (
      date: [10/2022],
      title: [#nth(10) Workshop on Cosmology and Structure Formation],
    ...
    // (
    //     date: [06/2020],
    //     title: [yt workshop. Tutor of one of the 'hands-on' sessions],
  ...
  "Seminars": (
    (
      date: [12/2025],
      title: [Seminar PKU/KIAA],
      location: [Peking University/Kavli Institute for Astronomy and Astrophysics, Beijing, China],
      description: none,
    ),
    (
      date: [12/2025],
      title: [Colloquium Tsinghua University],
      location: [Tsinghua University, Beijing, China],
      description: none,
    ),
    (
      date: [06/2025],
      title: [Institute for Fundamental Physics of the Universe seminar],
      location: [IFPU, Trieste, Italy],
      description: none,
    ),
    (
      date: [04/2025],
      title: [City University New York (CUNY) Physics Seminar],
      location: [CUNY, New York, USA (online)],
      description: none,
    ),
    (
      date: [04/2023],
      title: [Kavli Institute for Theoretical Physics blackboard talk],
      location: [KITP, Santa Barbara, USA],
    ...
    (
      date: [02/2022],
      title: [Berkeley Cosmology Seminar],
      location: [_online_, Berkeley, USA],
      description: none,
    ),
    (
      date: [11/2021],
      title: [Oxford Cosmology Seminar],
      location: [Oxford, UK],
      description: none,
    ),
  ),
  "Contributed talks": (
    ...
    (
      ...
      location: [Observatoire de Strasbourg, Strasbourg, France],
      description: none,
    ),
    (
      date: [11/2024],
      title: [Dyablo Workshop],
      location: [IAP, France],
      description: none,
    ),
    (
      date: [09/2024],
      title: [Framing the Big Picture of Galaxy Star Formation Quenching with JWST and Euclid],
      location: [ESAC, Madrid, Spain],
      description: none,
    ),
    (
      date: [09/2024],
      title: [High-$z$ Kinematics Workshop III],
